...
@RestController
@RequestMapping("/api/v1/group-courses/{groupCourseId}/enrollment")
...
public class EnrollmentController {
    ...
    public ResponseEntity<?> enroll(
        ...
        EnrollmentResponse enrollment = enrollmentService.enrollCourse(groupCourseId, user);
    ...
    public ResponseEntity<EnrollmentResponse> getMyEnrollment(
        ...
        return enrollmentService.findMyEnrollment(groupCourseId, user)
