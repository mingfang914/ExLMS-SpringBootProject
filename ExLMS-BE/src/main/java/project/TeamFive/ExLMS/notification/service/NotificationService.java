...
public class NotificationService {
    ...
    /**
     * Thông báo cho toàn bộ thành viên trong nhóm khi có nội dung mới được PUBLISHED.
     * Gửi cả thông báo nội bộ và Email.
     */
    @Async
    @Transactional
    public void notifyGroupPublishedItem(StudyGroup group, String typeStr, String title, String status, UUID entityId, String path) {
        // 1. Luôn Phát bản tin để UI đang mở tự refresh (kể cả khi không phải PUBLISHED, ví dụ sửa nháp)
        ...
        if ("Bài tập".equalsIgnoreCase(typeStr)) notificationType = Notification.NotificationType.NEW_ASSIGNMENT;
        else if ("Bài kiểm tra".equalsIgnoreCase(typeStr)) notificationType = Notification.NotificationType.NEW_QUIZ;
        else if ("Khóa học".equalsIgnoreCase(typeStr)) notificationType = Notification.NotificationType.NEW_COURSE;
        ...
        // 3. Tạo thông báo nội bộ cho từng người
        ...
        // 4. Gửi Email thông báo (BCC tất cả thành viên)
